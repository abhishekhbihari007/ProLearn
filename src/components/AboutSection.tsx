  ...
  const values = [
    {
      icon: Target,
      title: "Our Mission",
      description: "To democratize education by connecting world-class experts with eager learners worldwide.",
    },
    {
      icon: Users,
      title: "Community First",
      description: "Building a supportive network where knowledge flows freely and connections flourish.",
    },
    {
      icon: TrendingUp,
      title: "Innovation & Growth",
      description: "Staying at the forefront of educational technology to deliver cutting-edge learning experiences.",
    },
    {
      icon: Shield,
      title: "Quality Assured",
      description: "Every instructor is vetted, every course is reviewed, ensuring exceptional educational standards.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {values.map((value, index) => (
            <div
              key={index}
              className="bg-card p-8 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 group"
            >
